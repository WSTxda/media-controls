...
export default class MediaControlsPreferences extends ExtensionPreferences {
    ...
    bindSettings() {
        ...
        this.bindSetting("colored-player-icon-menu", "sr-general-colored-player-menu", "active");
        this.bindSetting("cover-art-radius", "sr-general-cover-art-radius", "value");
     ...
     */
    async clearCache() {
        const cacheDir = GLib.build_pathv("/", [GLib.get_user_cache_dir(), "mediacontrols@m-obeid.github.com"]);
